...
class Song:
    ...
    def __init__(self, songID):
        ...
        self.segmentPitches = None
        self.segmentTimbre = None
...
def main():
    ...
    basedir = msd_subset_data_path # "." As the default means the current directory
    ...
    for root, dirs, files in os.walk(basedir):        
        ...
        for f in files:
            ...
            # song.segmentPitches = str(hdf5_getters.get_segments_pitches(songH5File))
            # song.segmentTimbre = str(hdf5_getters.get_segments_timbre(songH5File))
